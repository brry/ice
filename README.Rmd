...
icePlot(kl$Tag, kl$EISHOCKEY, temp=kl$TMK.Lufttemperatur, label_gof=FALSE,
        staroffset=0.2, main="", addyears=0)
at <- par("usr")[1]+10
main <- function(txt, col=1)
  {
  mtext(txt, side=3, line=2.5, at=at, col=col, cex=1, adj=0)
...
*Note: the mailing list is currently broken.* 
We have a [WhatsApp group for Potsdam](https://chat.whatsapp.com/Fr7jS8lyqk2HEartrjN4nJ) and a [WhatsApp community for Brandenburg adH](https://chat.whatsapp.com/GNZhYHLWmNy90Ij2rRIrJA).
