...
- [Mailman Emailverteiler](http://lists.astaup.de/listinfo/eishockeysanssouci) defekt, wird gerade ersetzt mit:
- [UP Emailverteiler](mailto:eis-list@uni-potsdam.de) (sende Email mit Betreff subscribe an [eis-list-join@uni-potsdam.de](mailto:eis-list-join@uni-potsdam.de?subject=subscribe))
